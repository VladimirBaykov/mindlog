    ...
    <div className="mt-10 space-y-4">
      <div className="rounded-3xl border border-white/10 bg-white/[0.03] px-6 py-8 text-center">
        ...
        <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-neutral-400">
          Start a conversation and close it when you’re done.
          MindLog will save it here as a private reflection entry you
          can revisit later.
        </p>
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-4">
          ...
          <p className="mt-2 text-xs leading-relaxed text-neutral-400">
            Your first conversation becomes the start of your private
            reflection history.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-4">
          ...
          <p className="mt-2 text-xs leading-relaxed text-neutral-400">
            As entries build up, MindLog starts showing emotional themes
            and stronger patterns.
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-4">
          ...
          <p className="mt-2 text-xs leading-relaxed text-neutral-400">
            Pro unlocks deeper summaries once you’ve built enough
            reflection history.
          </p>
        </div>
      </div>
