...
import { JournalEnglishDateGuard } from "@/components/journal/JournalEnglishDateGuard";
import OpenedReflectionHeaderPolish from "@/components/journal/OpenedReflectionHeaderPolish";
        ...
        <HeaderProvider>
          <ToastProvider>
            <JournalProvider>
              ...
              <JournalEnglishDateGuard />
              <OpenedReflectionHeaderPolish />
              <Header />
